...
<title>Bienvenue à EDUSPHERE</title>
 ...
 <nav aria-label="breadcrumb">
  <ol class="breadcrumb" style="background:linear-gradient(to right,rgba(100,150,150, 1),rgba(150, 150, 150, 1))">
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="../../language.php" style="color:white;">Langues</a></li>
    <li class="breadcrumb-item active" aria-current="page"><a href="../../language_arabic.php" style="color:white;">Arabe</a></li>
    <li class="breadcrumb-item active" aria-current="page"><a href="language_arabic_arabic_khatawaat1.php" style="color:white;">Langue arabe pour débutants</a></li>
                  ...
                  <div class="card">
                    <div class="card-header" id="headingOne">
                      <h2 class="mb-0">
                        ...
                        Chapitre 1 : Comment écrire en arabe
                        </button>
                      </h2>
                    </div>
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                      <div class="card-body">
                        <a href="actualvideocontent_khatawaat1.php?video=1">&#10170  ÉTAPE 1 - Alphabet arabe - Partie 1 - COMMENT ÉCRIRE</a><br>
                        <a href="actualvideocontent_khatawaat1.php?video=2">&#10170  ÉTAPE 2- Alphabet arabe - Partie 2 COMMENT ÉCRIRE l alphabet arabe</a><br>
                        <a href="actualvideocontent_khatawaat1.php?video=3">&#10170  ÉTAPE 3 - Positions des lettres - COMMENT CONNECTER LES LETTRES</a><br>
                        <a href="actualvideocontent_khatawaat1.php?video=5">&#10170  ÉTAPE 4 - COMMENT CONNECTER DES LETTRES EN ARABE - COMMENT ÉCRIRE DES MOTS EN ARABE.</a><br>
                      </div>
                    </div>
                  </div>';
                  break;
                  ...
                  <div class="card">
                    <div class="card-header" id="headingTwo">
                      <h2 class="mb-0">
                        ...
                        Chapitre 2 : Comment lire en arabein Arabic
                        </button>
                      </h2>
                    </div>
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionExample">
                      <div class="card-body">
                        <a href="actualvideocontent_khatawaat1.php?video=4">&#10170  ÉTAPE 5 - VOYELLES LONGUES ET COURTES EN ARABE - COMMENT PRONONCER L ARABE</a><br>
                        <a href="actualvideocontent_khatawaat1.php?video=6">&#10170  ÉTAPE 6 - LIRE ET ÉCRIRE DES MOTS ARABES avec des voyelles LONGUES ET COURTES</a><br>
                        <a href="actualvideocontent_khatawaat1.php?video=7">&#10170  ÉTAPE 7- SONS ARABES - SONS DE LETTRE/Sons profonds et frontaux Cours d arabe étape par étape gratuits.</a><br>
                        <a href="actualvideocontent_khatawaat1.php?video=8">&#10170  ÉTAPE 7- SONS ARABES - SONS DE LETTRE/Sons profonds et frontaux Cours d arabe étape par étape gratuitsnners</a><br>
                      </div>
                    </div>
                  </div>';
                  break;
                  ...
                  <div class="card">
                    <div class="card-header" id="headingThree">
                      <h2 class="mb-0">
                        ...
                        Chapitre 3 : Pronoms et adjectifs
                        </button>
                      </h2>
                    </div>
                    <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordionExample">
                      <div class="card-body">
                        <a href="actualvideocontent_khatawaat1.php?video=9">&#10170  ÉTAPE 10 - PRONOMS POSSESSIFS ARABES/ FEMININ ET MASCULIN ARABE ضمائر الملكية - المؤنث و المذكر</a><br>
                        <a href="actualvideocontent_khatawaat1.php?video=10">&#10170 ÉTAPE 9 - ADJECTIFS EN ARABE - Cours d arabe gratuits étape par étape, féminin et masculin.</a><br>
                        <a href="actualvideocontent_khatawaat1.php?video=11">&#10170 ÉTAPE 11- Arabe Féminin/Masculin- COMMENT ÉCRIRE UNE PHRASE DE DEUX MOTS EN ARABIE</a><br>
                        <a href="actualvideocontent_khatawaat1.php?video=12">&#10170  Étape 12 -Def/indef- COMMENT DÉFINIR DES MOTS EN ARABE Article défini "Alif Laam" المعرفة والنكرة</a><br>
                        <a href="actualvideocontent_khatawaat1.php?video=13">&#10170  Conseils d apprentissage - COMMENT MÉMORISER ALPHABET ARABE - Étapes d apprentissage-</a><br>
                        <a href="actualvideocontent_khatawaat1.php?video=14">&#10170  Verbes arabes - Pratique n°7 - Négation avec les verbes arabes. NE PAS/ NE PAS FAIRE+Verbe</a><br>
                        </div>
                    </div>
                  </div>';
                  break;
                case '4':
                  ...
                  <div class="card">
                    ...
                    <div id="collapseFour" class="collapse show" aria-labelledby="headingFour" data-parent="#accordionExample">
                      <div class="card-body">
                        <a href="actualvideocontent_khatawaat1.php?video=15">&#10170  Questions arabes- Pratique n°6- Comment demander en arabe ? - Entraînez-vous à utiliser من؟ هل ؟ ما؟ ماذا؟</a><br>
                        <a href="actualvideocontent_khatawaat1.php?video=16">&#10170  Noms arabes - Pratique n°4 Apprenez le vocabulaire arabe par catégories (personnes, lieux, objets, boissons).</a><br>
                        <a href="actualvideocontent_khatawaat1.php?video=17">&#10170  Cours arabe gratuits #learn_arabic تعلم_ العربية# Months of the Year in Arabic-/Seasons of the Year</a><br>
