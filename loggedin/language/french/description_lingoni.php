          ...
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                  <h1 data-aos="fade-up" data-aos-delay="0" class="text-white">Cours de français B1</h1>
                  <p data-aos="fade-up" data-aos-delay="100" class="text-white">1 cours / 2 semaines &bullet; 250 students &bullet; <a href="#" class="text-white">2 comments</a></p>
                </div>
              </div>
            </div>
              ...
              <ul class="comment-list">
                ...
                <li class="comment">
                  ...
                  <div class="comment-body">
                    <h3>Samia Dalia</h3>
                    <div class="meta">October 2, 2023 at 7:00pm</div>
                ...
                <li class="comment">
                  ...
                  <div class="comment-body">
                    <h3>Emmanuel Tchabo</h3>
                    <div class="meta">January 17, 2023 at 5:40am</div>
    ...
    <footer class="footer-section bg-light">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <h3>Subscribe</h3>
            <p>Keep yourself up to date and receive all kind of news about EDUSPHERE.</p>
        ...
        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank" >NdeyeF</a>
        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
      </p>
            </div>
          </div>
