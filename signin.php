<?php
  ...
  <main>
    ...
    if (isset($_GET['error'])){
      if ($_GET['error']=="emptyfields"){
        ...
        echo '<div class="alert alert-danger" role="alert">Il y a aucune correspondance pour votre email !</div>';
  ...
  <form action="includes/login.inc.php" method="post">
    <table>
      ...
      <tr>
        <td><button style="border-radius: 12px;padding:11px 16px;font-weight:bolder" type="submit" name="login-submit">Se connecter</button></td>
      </tr>
    </table>
  </form>
