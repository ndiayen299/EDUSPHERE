    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.php">EDUSPHERE</a></div>

          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                <li><a href="index.php#home-section" class="nav-link">Accueil</a></li>
                <li><a href="index.php#courses-section" class="nav-link">formations</a></li>
                <li><a href="index.php#programs-section" class="nav-link">Cours</a></li>
                <li><a href="index.php#teachers-section" class="nav-link">Notre Equipe</a></li>
              </ul>
            </nav>
          </div>
          ...
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                  <h1 data-aos="fade-up" data-aos-delay="0" style="Color:white;">Réinitialisation du mot de passe !</h1>
                </div>
              </div>
            </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-7">
            ...
            <h2 class="section-title mb-3">Entrer votre Email</h2>
                ...
                <div class="col-md-12">
                  <?php if (isset($_GET['error1'])) {
                    if ($_GET['error1']=='nomail'){
                      echo '<div style="color:red;">Nous n’avons pas trouvé cet e-mail dans notre base de données!</div>';
                    }else if ($_GET['error1']=='empty_field'){
                      echo '<div style="color:red;">Vous devez saisir votre email!</div>';
                    }
                  }?>
    ...
    <footer class="footer-section bg-white">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <h3>S'abonner</h3>
            <p>Tenez-vous au courant et recevez toutes sortes de nouvelles sur EDUSPHERE</p>
            <form action="https://mailchi.mp/064deb47eeaa/lacdemy" target="_blank" class="footer-subscribe">
              <div class="d-flex mb-5">

                <input type="submit" class="btn btn-primary rounded-0" value="S'abonnere">
              </div>
            </form>
          </div>
